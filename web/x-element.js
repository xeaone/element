  ...
  if (this.name === "value") {
    ...
    if (typeof source === "function") {
      ...
      if (this.previousName)
        this.element.removeEventListener(this.previousName?.slice(2), source);
    }
    this.value = target;
...
var _isCreatingOrCreated, _context, _root, _marker, _actions, _expressions, _changeNext, _a, _change, change_fn, _setup, setup_fn;
...
change_fn = async function() {
  const change = async () => {
    ...
    this[changeSymbol] = (_a2 = __privateGet(this, _changeNext)) == null ? void 0 : _a2.call(this);
