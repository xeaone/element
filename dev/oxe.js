...
class Component extends HTMLElement {
    ...
    get css() { return __classPrivateFieldGet$1(this, _css); }
    get model() { return __classPrivateFieldGet$1(this, _model); }
    get binder() { return __classPrivateFieldGet$1(this, _binder); }
    render() {
        const template = document.createElement('template');
        template.innerHTML = this.constructor.template;
        const clone = template.content.cloneNode(true);
        if (__classPrivateFieldGet$1(this, _adopt) === true) {
        ...
        if (__classPrivateFieldGet$1(this, _shadow) && 'attachShadow' in document.body) {
            __classPrivateFieldSet(this, _root, this.attachShadow({ mode: 'open' }));
        }
        else if (__classPrivateFieldGet$1(this, _shadow) && 'createShadowRoot' in document.body) {
        ...
        while (child) {
            Binder$1.add(child, this);
            __classPrivateFieldGet$1(this, _root).appendChild(child);
            child = clone.firstElementChild;
        }
    }
    attributeChangedCallback(name, oldValue, newValue) {
        Promise.resolve().then(() => __classPrivateFieldGet$1(this, _attributed).call(this, name, oldValue, newValue));
    }
    adoptedCallback() {
        Promise.resolve().then(() => __classPrivateFieldGet$1(this, _adopted).call(this));
    }
    disconnectedCallback() {
        __classPrivateFieldGet$1(this, _css).detach(__classPrivateFieldGet$1(this, _name));
        Promise.resolve().then(() => __classPrivateFieldGet$1(this, _detached).call(this));
    }
    connectedCallback() {
        __classPrivateFieldGet$1(this, _css).attach(__classPrivateFieldGet$1(this, _name), this.constructor.css);
        if (this.CREATED) {
            Promise.resolve().then(() => __classPrivateFieldGet$1(this, _attached).call(this));
        }
        else {
            this.CREATED = true;
            this.render();
            Promise.resolve().then(() => __classPrivateFieldGet$1(this, _created).call(this)).then(() => __classPrivateFieldGet$1(this, _attached).call(this));
        }
    }
}
...
var Fetcher = new class Fetcher {
    ...
    get() {
        return __awaiter$4(this, arguments, void 0, function* () {
...
var Router = new (_a$1 = class Router {
        ...
        setup(option = {}) {
            ...
            return __awaiter$6(this, void 0, void 0, function* () {
                __classPrivateFieldSet$1(this, _after, option.after);
                __classPrivateFieldSet$1(this, _before, option.before);
                __classPrivateFieldSet$1(this, _external, option.external);
                __classPrivateFieldSet$1(this, _mode, (_a = option.mode) !== null && _a !== void 0 ? _a : 'push');
                __classPrivateFieldSet$1(this, _contain, (_b = option.contain) !== null && _b !== void 0 ? _b : false);
                __classPrivateFieldSet$1(this, _folder, (_c = option.folder) !== null && _c !== void 0 ? _c : './routes');
                __classPrivateFieldSet$1(this, _target, option.target instanceof Element ? option.target : document.body.querySelector(option.target || 'main'));
                if (__classPrivateFieldGet$2(this, _mode) !== 'href') {
        ...
        add(data) {
            return __awaiter$6(this, void 0, void 0, function* () {
                if (!data) {
                    ...
                    if (load.slice(0, 1) === '/')
                        load = load.slice(1);
                    if (__classPrivateFieldGet$2(this, _folder).slice(-1) === '/')
                        __classPrivateFieldSet$1(this, _folder, __classPrivateFieldGet$2(this, _folder).slice(0, -1));
                    load = __classPrivateFieldGet$2(this, _folder) + '/' + load;
        ...
        find(path) {
            return __awaiter$6(this, void 0, void 0, function* () {
                ...
                load.unshift(__classPrivateFieldGet$2(this, _folder));
                load = load.join('/');
                const route = yield this.load({ path, name, load });
        ...
        render(route) {
            return __awaiter$6(this, void 0, void 0, function* () {
                ...
                if (__classPrivateFieldGet$2(this, _target)) {
                    while (__classPrivateFieldGet$2(this, _target).firstChild) {
                        __classPrivateFieldGet$2(this, _target).removeChild(__classPrivateFieldGet$2(this, _target).firstChild);
                    }
                    __classPrivateFieldGet$2(this, _target).appendChild(route.target);
                }
                window.scroll(0, 0);
            });
        }
        ...
        route(path, options = {}) {
            return __awaiter$6(this, void 0, void 0, function* () {
                ...
                const mode = options.mode || __classPrivateFieldGet$2(this, _mode);
                const route = yield this.find(location.pathname);
                if (!route) {
                    throw new Error(`Oxe.router.route - missing route ${location.pathname}`);
                }
                if (typeof __classPrivateFieldGet$2(this, _before) === 'function') {
                    yield __classPrivateFieldGet$2(this, _before).call(this, location);
                }
                if (route.handler) {
                ...
                Events(__classPrivateFieldGet$2(this, _target), 'before', location);
                if (mode === 'href') {
                ...
                if (typeof __classPrivateFieldGet$2(this, _after) === 'function') {
                    yield __classPrivateFieldGet$2(this, _after).call(this, location);
                }
                Events(__classPrivateFieldGet$2(this, _target), 'after', location);
            });
        }
        ;
        state(event) {
        ...
        click(event) {
            return __awaiter$6(this, void 0, void 0, function* () {
                ...
                if (__classPrivateFieldGet$2(this, _contain)) {
                    while (parent) {
                        if (parent.nodeName === __classPrivateFieldGet$2(this, _target).nodeName) {
                            break;
                        }
                        else {
                ...
                if (target.hasAttribute('download') ||
                    ...
                    return;
                if (__classPrivateFieldGet$2(this, _external) &&
                    (__classPrivateFieldGet$2(this, _external) instanceof RegExp && __classPrivateFieldGet$2(this, _external).test(target.href) ||
                        typeof __classPrivateFieldGet$2(this, _external) === 'function' && __classPrivateFieldGet$2(this, _external).call(this, target.href) ||
                        typeof __classPrivateFieldGet$2(this, _external) === 'string' && __classPrivateFieldGet$2(this, _external) === target.href))
                    return;
                event.preventDefault();
...
Oxe.component = Component;
Oxe.location = Location;
Oxe.batcher = Batcher;
Oxe.fetcher = Fetcher;
Oxe.router = Router;
Oxe.binder = Binder$1;
